...
class TestLoadConfig(unittest.TestCase):
    ...
    def test_load_config_default_path(self):
        ...
        config_data = {
            "cassandra": {"hosts": ["localhost"], "port": 9042, "keyspace": "demo"}
        }
...
class TestMain(unittest.TestCase):
    ...
    def test_main_success(
        self, mock_table_class, mock_connection_class, mock_load_config
    ):
        ...
        mock_connection_class.assert_called_once_with(hosts=["localhost"], port=9042)
    ...
    def test_main_with_custom_config(
        ...
        mock_connection_class.assert_called_once_with(
            hosts=["node1.example.com", "node2.example.com"], port=9043
        )
